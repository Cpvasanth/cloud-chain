    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `c96523a5703021c4c90a`,
            pinata_secret_api_key: `94fb826765f7bf9dc8479b2e110906d955dd4befe44cd6f7b5e1fb5dad9ef180`,
            "Content-Type": "multipart/form-data",
          },
        });
        // const ImgHash = `https://gateway.pinata.cloud/ipfs/amethyst-secret-cricket-393.mypinata.cloud`;
        // const ImgHash = `https://gateway.pinata.cloud/ipfs/${resFile.data.IpfsHash}`;
        const ImgHash = `https://amethyst-secret-cricket-393.mypinata.cloud/ipfs/${resFile.data.IpfsHash}`;
